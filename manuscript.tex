...
% Running title (for journal header; IEEEtran has no dedicated \runningtitle
% command --- if moving to a Wiley/STVR template, set this via that template's
% short-title mechanism, e.g. \runninghead{LLM Unit Test Generation for Express.js}).
% Running title: LLM Unit Test Generation for Express.js
...
% ---- Corresponding author details (for journal submission systems /
% cover page; not all fields render under IEEEtran's \author macro, so
% they are also listed explicitly here for manual entry into the
% journal's submission form). ----
% Corresponding author: Kanishk Bairagi
% Postal address: [INSERT YOUR FULL POSTAL ADDRESS HERE BEFORE SUBMISSION]
% Email: kanishk.bairagi00@gmail.com
% ORCID: https://orcid.org/0009-0001-8029-1973
...
\begin{IEEEkeywords}
Large language models; automated test generation; software testing; Express.js; mutation testing; empirical software engineering
\end{IEEEkeywords}
...
To support replication, including running the repeated-trial extension described above, the evaluation harness, controller dataset, generated test suites, and raw JSON execution logs are made available at: \url{https://github.com/kanishkbairagi/express_llm_benchmark1}.
...
The evaluation harness, controller dataset, generated test suites, and raw JSON execution logs supporting this study are publicly available at: \url{https://github.com/kanishkbairagi/expressllmbenchmark1}.
...
This study did not involve human participants, human subjects, or animals; therefore, ethics approval was not required.

\subsection*{Author Contributions}
Kanishk Bairagi conceived and designed the study, developed the evaluation harness, conducted the experiments and analysis, prepared the research artifacts, and wrote the manuscript.
